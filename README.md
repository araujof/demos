...
| [cpex-policy-engine](demos/cpex/) | Policy enforcement on MCP traffic: authorization flows connecting identity to access control decisions with Cedar or CEL PDP, delegation, data redaction, and session tainting. |
